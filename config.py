...
DENSE_POSITION = [288, 512, 1024, 2048, 4092, 8192, 8192, 8192, 4092, 2048, 1024, 512]

DENSE_DECK = [64, 128, 256, 256, 256]

DENSE_DRAWN_CARD = [64, 128, 256, 256, 256]

DENSE_SCORES = [1, 2, 4, 8, 16, 16, 16]

DENSE_POLICY_HEAD = [1024, 1024, 2048, 4092, 4092, 4092, 4092, 2048, 1024, 512, 256, 128, 64, 32, 16, 16]
...
# Play versions
GAME_AMOUNT_PLAY_VERSIONS = 100000
