...
BUFFER_REQUIREMENT = 3000  # Minimum amount of new positions required for each self-play iteration
BUFFER_SIZE = 30000  # Replay buffer size
data_choser = lambda version, length: round(-1 - version * 2 * (length - 1) / LOOP_ITERATIONS)  # How early data used in training
