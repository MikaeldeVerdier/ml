...
DENSE_POSITION = [2048, 2048, 2048, 1024, 512]

DENSE_DECK = [64, 128, 128]

DENSE_DRAWN_CARD = [64, 128, 128]

DENSE_SCORES = [2, 4, 8, 16, 16]

DENSE_POLICY_HEAD = [800, 512, 512, 256, 128, 64, 32, 32]
USE_BIAS = True
