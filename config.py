...
CONVOLUTIONAL_LAYERS_POSITION = [(32, (3, 3, 3)), (64, (3, 3, 3)), (128, (3, 3, 3)), (256, (3, 3, 3)), (512, (3, 3, 3)) (512, (3, 3, 3))]
DENSE_POSITION = [1024, 1024, 1024]

CONVOLUTIONAL_LAYERS_DECK = [(32, 3), (64, 3), (64, 3)]
DENSE_DECK = [1024, 1024, 1024]

CONVOLUTIONAL_LAYERS_DRAWN_CARD = [(32, 3), (64, 3), (64, 3)]
DENSE_DRAWN_CARD = [1024, 1024, 1024]

DENSE_SHARED = [1024, 512]
DENSE_POLICY_HEAD = [512, 256]
USE_BIAS = True
