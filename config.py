from funcs import linear_decorator
...
epsilon = linear_decorator(1, 0.1, VERSION_AMOUNT / 2)  # Probability of choosing a random move, if not specified
...
learning_rate = linear_decorator(1e-5, 1e-6, VERSION_AMOUNT * 0.9)
